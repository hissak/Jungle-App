  ...
  describe 'Validations' do
    ...
    context 'when a field is missing' do
      it 'should not save successfully' do
        @category = Category.new(name: 'Bananas')
        @product1 = Product.new(name: nil, price_cents: 60, quantity: 4, category: @category)
        @product2 = Product.new(name: 'Cats', price_cents: nil, quantity: 4, category: @category)
        @product3 = Product.new(name: 'Cats', price_cents: 60, quantity: nil, category: @category)
        @product4 = Product.new(name: 'Cats', price_cents: 60, quantity: 4, category: nil)
